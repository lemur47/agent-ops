...
> **This skill is organisation-neutral.** The values specific to your organisation — who your core audience is, who owns confidentiality sign-off, which agreements bind you — live in a local overlay (`CALIBRATION.local.md`) kept out of version control, not in this file. Create your own from the `CALIBRATION.template.md` beside this skill, following [Method Is Public; Your Values Are Not](../../README.md#method-is-public-your-values-are-not) in the repository README, which describes the overlay's minimum contents, the three-rung lookup, and where it may live. The four-layer structure and decision procedure below are universal.
>
